...
urlpatterns = [
    path('',av.index),#leave this
    path('LoginOrg', av.org_login),#done
    path('SignUpOrg',av.org_register),#done
    path('LoginUser', av.user_login),#done
    path('VerifyEmail',av.verifyEmail),
    path('logout',av.logout),#done
    path('contact',av.contact),
    path('faq', av.faq),
    path('org_index', av.org_index),#done
    path('user_index', av.user_index),#done
    path('org_change_password',av.org_change_password),#done
    path('user_change_password', av.user_change_password),#Done
    path('org_report_problems',av.report_org),
    path('user_report_problems', av.report_emp),
    path('create-emp',av.add_emp),#Done
    path('read-emp',av.read_emp),#Done
    path('view-emp/<int:eid>', av.view_emp),#Done
    path('update-emp/<int:eid>', av.update_emp),#Done
    ...
    path('del-emp/<int:eid>', av.del_emp),#Done
    ...
    path('work-productivity-check', av.work_productivity_check), #pending
    path('user-work-productivity-check', av.user_work_productivity_check), #pending
    ...
    path('logDashboard', av.logDashboard), #pending
    ...
    path('emp-view-notices', av.emp_view_notices), #Done
    ...
    path('org-view-attendance', av.org_view_attendance),#Pending
    path('user-view-attendance', av.user_view_attendance), #Done
    path('get_emp_logged_in_count_today', av.get_emp_logged_in_count_today), #Done
