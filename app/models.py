...
class Project(models.Model):
    ...
    p_desc = models.CharField(max_length=2500)
    o_id = models.ForeignKey(Organization, on_delete=models.CASCADE)
...
class Task(models.Model):
    ...
    t_desc = models.CharField(max_length=2500)
...
class Meeting(models.Model):
    ...
    m_desc = models.CharField(max_length=2500)
...
class OrganizationNews(models.Model): 
    ...
    on_desc = models.TextField(max_length=2500)
...
class AttendanceLogs(models.Model): #Done
    ...
    e_id = models.ForeignKey(Employee, on_delete=models.CASCADE)
    o_id = models.ForeignKey(Organization, on_delete=models.CASCADE)
    a_logged_in_time = models.CharField(max_length=55, null=True, blank=True)
    a_logged_out_time = models.CharField(max_length=55, null=True, blank=True)
    logged_in_total = models.CharField(max_length=55, null=True, blank=True)
    class Meta:
        db_table = "AttendanceLogs"


class Leaves(models.Model): #Done
    l_reason = models.CharField(max_length=55)
    l_desc = models.CharField(max_length=2500)
